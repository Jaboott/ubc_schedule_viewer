    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen">
            <div className="items-center justify-center w-[90vw] md:w-[48rem]">
                ...
                <h2 className="text-sm text-center text-[#83828B] pb-10">Get your schedule at: Academics -> Registration & Courses -> View My Courses -> Export to Excel (very top right)</h2>
